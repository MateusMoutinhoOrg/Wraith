...
## Description
Index of the documentation for people who drive the project from a terminal: installing the binary, running it, and looking up what each command does. Consuming the same behavior from Go code is indexed by [LibUsage.md](/docs/Index/LibUsage.md).

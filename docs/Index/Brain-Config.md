...
This repository is a template meant to be forked. The financial brain inside it — accounts, categories, transactions — is a worked example of the shape, not the point of it: swap the tasks and the visualizations and you have a brain for something else entirely.

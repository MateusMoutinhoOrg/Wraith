...
what each account will hold over the next 8 months. When the day arrives you still record what
actually happened with `AddTransaction`.
...
- The forecast horizon is fixed at the 8 months after the open one and moves with the calendar.
